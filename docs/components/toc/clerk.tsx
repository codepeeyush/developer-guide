    ...
    <>
      ...
      >
        ...
        <button
          type="button"
          onClick={scrollToTop}
          className="mt-2 border-fd-foreground/10 pt-2 text-left text-xs text-fd-muted-foreground hover:text-primary cursor-pointer"
        >
...
function TOCItem({
  ...
  return (
    <Primitive.TOCItem
      ...
      className="prose relative py-1.5 text-sm text-fd-muted-foreground hover:text-primary transition-colors wrap-anywhere first:pt-0 last:pb-0 data-[active=true]:text-fd-primary"
    >
      {offset !== upperOffset && (
        <svg
        ...
        >
          <line
            x1={upperOffset} y1="0" x2={offset} y2="12"
